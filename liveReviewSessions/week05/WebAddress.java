...
/*
Create a class named WebAddress, and write a program that can check if the given
website is valid website or not
            starts with: www.
 ...
 */
        ...
        boolean isValid = beginningOfUrl.equalsIgnoreCase("www") &&
                (endingOfUrl.equalsIgnoreCase("gov")||
                        endingOfUrl.equalsIgnoreCase("com")||
                        endingOfUrl.equalsIgnoreCase("edu"));
