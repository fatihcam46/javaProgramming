...
Java Compiler checks the String Pool. And if there is alreay a string in the pool, Java does not create a new one.
        str1: reference to our String object, refernceName of Object, variableName
    ...
    * Strings are indexed based
    "Java";
     ...
     make a note paper: what methods asks from me (parameter)
                        what will this method reutrn to me
