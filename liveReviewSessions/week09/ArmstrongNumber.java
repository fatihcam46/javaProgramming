...
public class ArmstrongNumber {
    public static void main(String[] args) {
         /*
        	Task 4 :   Write a method that can check if a number is Armstrong number
				Note: if I have a 3-digit number then each of the digits is raised to the
				power of three and added to obtain a number. If the number obtained equals
				the original number then, we call that armstrong number.
    ...
    public static boolean isArmstrong(int number){
        ...
        int lastDigit = 0;
        int newNumber = 0;
        int originalNumber = number;  // since we will do some actions on the number,
        // I need to store the number at another variable
        /*
