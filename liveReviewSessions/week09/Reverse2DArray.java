...
public class Reverse2DArray {
    public static void main(String[] args) {
        ...
        int [][] reversed2Darr = new int[arr2D_1.length][];
        // we create an empty 2d array, I know the size of 2d array,
        // however I don't know the sizes of 1d arrays
        int index2D = 0;
        for(int i = arr2D_1.length-1; i>= 0 ; i--){//last element
            int [] reversed1Darr = new int[arr2D_1[i].length];
            // empty 1D array that will hold reversed 1D arrays temporarily
        ...
        //[[190, -1110, 4602, 415, 135, 35], [115, 90, -110, 46, 41, 13, 3], [89, 100, -10, 34, 3]]
    }
}
