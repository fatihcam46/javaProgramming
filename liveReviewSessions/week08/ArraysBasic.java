...
public class ArraysBasic {
    public static void main(String[] args) {
        System.out.println("----first way of creating arrays-----------------");
        int code = 200;
        /*
        ...
        codes[0] = 200; // first element- index starts 0
        ...
        System.out.println(Arrays.toString(codes));// print statements of arrays
