...
public class SmallTasksWithArrayList {
    public static void main(String[] args) {
        ...
        numbers.set(numbers.size() - 1, 0);//last elements change 0
        System.out.println("numbers = " + numbers);//numbers = [1, 2, 3, 4, 0]
 ...
 /*         2. write a method that can swap the first and last elements of an ArrayList
        ...
        System.out.println("numbers after swapping = " + numbers);//numbers after swapping = [0, 2, 3, 4, 1]
  ...
  /*        3. write a method that can multiply each odd number by 2 in an arraylist
        ...
        //numbers after multiplier = [0, 2, 6, 4, 2]
        //which is odd multiply2
    }

    public static ArrayList<Integer> numberSwapper(ArrayList<Integer> arrayList) {
        Collections.swap(arrayList, 0, arrayList.size() - 1);//last index swap first element(0index)
        return arrayList;
    }
    ...
    public static ArrayList<Integer> oddMultiplier(ArrayList<Integer> arrayList) {
        ...
        // we use % modulus operator  //foreach method
