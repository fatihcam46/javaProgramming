...
/* Question-1:
         ...
         int i = 0 initialization(starting point)   for (initialization ; condition ; iteration){   }
         i<=1000 : condition(ending point)
         i+=10: iteration    co-related to Condition,10 by 10 increase             */
// -------iterate 10 by 10
        ...
        System.out.println("-------iterate 10 by 10--------------");
// iterate 1 by 1
