...
//        nums → [1, 33, 5, 7, 9]) → 33
//        hint:
///    _create a variable called max and before you start
// searching assume the first item value is the max._
////        _loop through each and every item and check for whether
//        the value max is less than the item value._
...
// //     _you will get the max value when you are done with the loop_
        public static void main(String[] args) {
            ...
            System.out.println("Write 5 numbers,let`s find max number:");
