...
//returns max number integer array
    public static int max(int[] numbers){
        Arrays.sort(numbers);
        return numbers[numbers.length-1];
    }

//returns max number double array
    public static double max(double[] numbers){
        Arrays.sort(numbers);
        return numbers[numbers.length-1];
    }

 //returns min number integer array
    public static int min(int[] numbers){
        Arrays.sort(numbers);
        return numbers[0];
    }

//returns min number double array
    public static double min(double[] numbers){
        Arrays.sort(numbers);
        return numbers[0];
    }

    //check if the given integer is contained in the given arrray.
    // returns boolean: contain(int[],int)
    public static boolean contains(int[] array, int element) {
        boolean result = false;
        for (int each : array) {
            if (each == element) {//if any arrays element is matching with the given elemen
                result = true;
            }
    ...
    //check if the given integer is contained in the given arrray.
    // returns boolean: contain(double[],double)
    ...
    //check if the given integer is contained in the given arrray.
    // returns boolean: contain(char[],char)
    ...
    //check if the given integer is contained in the given arrray.
    // returns boolean: contain(String[],String)
...
// adds the given element to array, returns a new array
 ...
 //removes the index from the array, returns new array
    public static int[] removeElement(int[] array, int index){
        ...
        int j = 0;
        for (int i= 0; i < array.length; i++) {// for each loop we cannot use==>use loop
...
//reverses the given array, returns a new array
 ...
 // replaces all the matching old values of the array with the new value
    public static int[] replaceAll(int[] array, int oldValue, int newValue) {
        //for loop use it:                          //integer array, integer oldElement, integer newElement
        for (int i = 0; i < array.length; i++) {
