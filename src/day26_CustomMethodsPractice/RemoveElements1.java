...
public class RemoveElements1 {
    ...
    public static void main(String[] args) {
        ...
        numbers = removeElement(numbers, 1); //{100, 300, 400, 500, 600}//index number 1(200) remove it
        System.out.println(Arrays.toString(numbers));//[100, 300, 400, 500, 600]
        numbers = removeElement(numbers, 1); //[100, 400, 500, 600]//index number 1(400) remove it
...
2. Create a class named RemoveElements:
			...
			an integer array and an integer index. the method removes the element at the given
