...
public class StrongPassword {
    public static void main(String[] args) {
        String password = "Cydewooden@";
        boolean r1 = password.length() >= 8 && !password.contains(" ");//at least 8 character and no space
    ...
    char[] chars = password.toCharArray();
        for (char each : chars) {
            if(Character.isUpperCase(each)){//any character is upper case===>true
                r2 = true;
            }else if(Character.isLowerCase(each)){//any character is lower case===>true
                r3 = true;
            }else if(Character.isDigit(each)){//any character is digit===>true
                r5 = true;
            }else{ //special character
                r4 = true;
            }
        }                         //as long as one is not true all false
        boolean isStrongPassword = r1 && r2 && r3 && r4 && r5;

        System.out.println("isStrongPassword = " + isStrongPassword);//"Cyde1990@" true   "Cydewooden@" false
                                                                                        //there is no digit
