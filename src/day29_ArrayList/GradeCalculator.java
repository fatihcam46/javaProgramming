...
//how many A B  C  D   F?
        //Without using loop:from ArrayList  removeIf  use:

        ArrayList<Integer> gradeOfA = new ArrayList<>( scores ); // 90 ~ 100
        gradeOfA.removeIf( p ->  !(p >= 90 && p <= 100)  );//lambda//90ile100 digerlerini cikar
