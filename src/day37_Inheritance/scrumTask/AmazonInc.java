...
public class AmazonInc {
    public static void main(String[] args) {
        ...
        //System.out.println(testers.toString()); it cannot
        System.out.println(Arrays.toString(testers));//if you want to you can print it
        //[Employee{name='Chinara', age=32, gender=F, id=1415, jobTitle='QA', salary= $125000.0, companyName='Amazon Inc'},
        // Employee{name='Yasaman', age=31, gender=F, id=1416, jobTitle='QE', salary= $130000.0, companyName='Amazon Inc'},
        // Employee{name='Irena', age=29, gender=F, id=1417, jobTitle='SDET', salary= $128000.0, companyName='Amazon Inc'},
        // Employee{name='Cihad', age=26, gender=M, id=1418, jobTitle='QA', salary= $125000.0, companyName='Amazon Inc'}]
...
//ScrumTeam{PO=Suhaib, BA=Cihad, SM=Anel, number of testers=4, number of developers=5}
        System.out.println("-------------Testers--------------------------");
//every testers ,if you want to see
        for (Tester tester : scrumTeam.testers) {
            System.out.println(tester.name + " : " + tester.salary);
        }
/*
Chinara : 125000.0  Yasaman : 130000.0   Irena : 128000.0   Cihad : 125000.0
 */
        System.out.println("-------------Developers-----------------------------------");
//every Developer ,if you want to see
        for (Developer developer : scrumTeam.developers) {
            System.out.println(developer.name + " : " + developer.salary);
        }
        /*
        Max : 180000.0   Allison : 120000.0    Tom : 140000.0    Manas : 280000.0    Evelyn : 160000.0
         */
    }}